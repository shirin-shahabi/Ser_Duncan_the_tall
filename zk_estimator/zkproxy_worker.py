...
class ZkProxyWorker:
    def __init__(self) -> None:
        self.jst = JSTprove() if HAS_JSTPROVE else None
    ...
    def _health(self, params: dict) -> dict:
        return {
            "status": "ok",
            "jstprove_available": HAS_JSTPROVE,
    ...
    def _compile(self, params: dict) -> dict:
        ...
        if not HAS_JSTPROVE:
            return {"success": False, "error": "jstprove not installed"}
    ...
    def _verify(self, params: dict) -> dict:
        if not HAS_JSTPROVE:
            return {"verified": False, "error": "jstprove not installed"}
